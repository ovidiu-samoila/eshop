...
// more routes for our API will happen here
    ...
    // create a category
        .post(function(req, res) {
            ...
            category.namecat= req.body.namecat;
            category.description = req.body.description;  // set the bears name (comes from the request)
...
/////////////////////////////////
    ...
    // create a product
        .post(function(req, res) {
            ...
            product._creator= req.body._creator;
            ...
            product.save(function(err) {
                if (err)
                    res.send(err);
                Category.findById(req.body._creator, function(err, category) {
                    if (!err)
                        res.send(err);
